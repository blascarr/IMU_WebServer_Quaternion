...
if (!!window.EventSource) {
  ...
  source.addEventListener('gyro_readings', function(e) {
    ...
    // Change cube rotation with Quaternion form in order to avoid Kardan Block
    const quaternion = new THREE.Quaternion( );
    quaternion.set( parseFloat(obj.qx), parseFloat(obj.qy), parseFloat(obj.qz), parseFloat(obj.qw)  );
